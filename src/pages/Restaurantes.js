...
function Restaurantes() {
  ...
  const [showCreateRestaurantMenu, setShowCreateRestaurantMenu] =
    useState(false); // Estado para a exibição do menu de criação de restaurante
      ...
      <header className="header">
        <div className="nav">
          <ul className="nav-list">
            ...
            <li
              className="nav-item"
              onMouseOver={handleRestaurantMouseOver}
              onMouseOut={handleRestaurantMouseOut}
            >
              <a href="restaurantes">Restaurantes</a>
              {showCreateRestaurantMenu && (
                <ul className="sub-menu">
                  <li>
                    <a href="criarRestaurante">Criar Restaurante</a>
                  </li>
                </ul>
              )}
            </li>
        ...
        <div className="search-bar">
          ...
          <div className="search-icon">
            <img
              src="https://icones.pro/wp-content/uploads/2021/06/icone-loupe-rouge.png"
              alt="Lupa"
            />
          </div>
        </div>
        ...
        <div className="restaurant-list">
          ...
          <ul className="category-list">
            <li className="category-item" onClick={handleLanchesClick}>
              <img
                src="https://img.freepik.com/vetores-premium/lanche-delicioso-de-fast-food-com-coca-cola-de-hamburguer-e-legumes-frescos-em-uma-ilustracao-de-fundo-branco-ilustracao-de-coca-cola-quente-e-picante-de-batatas-fritas_759447-756.jpg"
                alt="Lanches"
              />
              Lanches
            </li>
            <li className="category-item" onClick={handleLanchesClick}>Promoções</li>
            <li className="category-item" onClick={handleLanchesClick}>Pizza</li>
            <li className="category-item" onClick={handleLanchesClick}>Japonesa</li>
            <li className="category-item" onClick={handleLanchesClick}>Doces & Bolos</li>
            <li className="category-item" onClick={handleLanchesClick}>Brasileira</li>
            <li className="category-item" onClick={handleLanchesClick}>Açaí</li>
            <li className="category-item" onClick={handleLanchesClick}>Árabe</li>
            <li className="category-item" onClick={handleLanchesClick}>Chinesa</li>
            <li className="category-item" onClick={handleLanchesClick}>Sorvetes</li>
            <li className="category-item" onClick={handleLanchesClick}>Italiana</li>
            <li className="category-item" onClick={handleLanchesClick}>Padarias</li>
            <li className="category-item" onClick={handleLanchesClick}>Carnes</li>
            <li className="category-item" onClick={handleLanchesClick}>Vegetariana</li>
            <li className="category-item" onClick={handleLanchesClick}>Gourmet</li>
            <li className="category-item" onClick={handleLanchesClick}>Pastel</li>
            <li className="category-item" onClick={handleLanchesClick}>Marmita</li>
            <li className="category-item" onClick={handleLanchesClick}>Salgados</li>
            <li className="category-item" onClick={handleLanchesClick}>Saudável</li>
          </ul>
          <h2>Destaques</h2>
      ...
      {showAddressModal && (
        <Modal onClose={handleCloseAddressModal}>
          <div className="modal-content">
            ...
            <GeoCode />{" "}
            {/* Componente para obter a localização atual do usuário */}
          </div>
        </Modal>
      )}
    </div>
